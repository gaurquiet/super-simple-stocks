...
public class SimpleStockServiceImpl implements SimpleStockService {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.jpmorgan.stocks.simple.services.SimpleStockService#
	 ...
	 * 
	 * @see
	 * com.jpmorgan.stocks.simple.services.SimpleStockService#calculatePERatio(
	 * java.lang.String)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.jpmorgan.stocks.simple.services.SimpleStockService#recordTrade(com.
	 * jpmorgan.stocks.simple.model.Trade)
	 */
	@Override
	...
	private double calculateStockPriceinRange(String stockSymbol, int minutesRange) throws Exception {
		...
		Collection<Trade> trades = CollectionUtils.select(stocksEntityManager.getTrades(),
	 ...
	 * 
	 * @see
	 * com.jpmorgan.stocks.simple.services.SimpleStockService#getTradesNumber()
	 */
